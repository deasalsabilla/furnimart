...
--
-- Host: localhost:3306
-- Generation Time: Apr 04, 2025 at 01:17 PM
...
INSERT INTO `tb_jual` (`id_jual`, `id_user`, `tgl_jual`, `total`, `diskon`) VALUES
('T001', 'U002', '2025-04-04 12:06:29', 950000, 50000),
('T002', 'U002', '2025-04-04 12:53:28', 1330000, 70000);
...
--
-- Dumping data for table `tb_jualdtl`
--

INSERT INTO `tb_jualdtl` (`id_jual`, `id_produk`, `qty`, `harga`) VALUES
('T001', 'P002', 1, 600000),
('T001', 'P003', 1, 400000),
('T002', 'P002', 1, 600000),
('T002', 'P005', 2, 800000);
